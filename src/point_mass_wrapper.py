...
sys.path.append("/home/eimer/Dokumente/dac_spl/sprl/deep_sprl")
from environments.contextual_point_mass import ContextualPointMass
...
class PointMassWrapper(pointMassEnv):
    def __init__(self, instance_feats, test, action_space_size=10):
        ...
        self.action_space = spaces.Discrete(action_space_size * action_space_size)
